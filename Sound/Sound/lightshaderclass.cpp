...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, int instanceCount,
	...
	XMFLOAT4 pointDiffuseColor, XMFLOAT4 PlightPosition)
{
	bool result;
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture,
		lightDirection, ambientColor, diffuseColor, cameraPosition, specularColor, specularPower, pointDiffuseColor, PlightPosition);
	if (!result)
	{
		return false;
	}
...
bool LightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext,
	...
	ID3D11ShaderResourceView* texture,
	XMFLOAT3 lightDirection, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor,
	XMFLOAT3 cameraPosition, XMFLOAT4 specularColor, float specularPower, XMFLOAT4 pointDiffuseColor, XMFLOAT4 lightPosition)
{
	HRESULT result;
